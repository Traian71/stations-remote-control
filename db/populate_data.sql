...
INSERT INTO date_configurare_cabine (
    ...
    prescrisa_pc_v, mod_reglare, mod_transmisie,
    longitudine, latitudine,
    serie_fabricatie_cabina, serie_fabricatie_modul, lot, data_punere_functiune
) VALUES
-- tip_injectie: 0=NONE, 1=NORMAL/ON, 2=OFF, 3=INTENSIVE | mod_reglare: 0=PCoff, 1=PCon | mod_transmisie: 0=PROGRAMAT, 1=CURENT
...
('București-Ploiești', 'Otopeni Conductă 2', 1002, 3, '03:00:00', 24, 4, '15:00:00', 10, 4, 90, -0.900, 1, 0, 26.1534567, 44.5489012, 'C1002', 'M1002', 'L2023-01', '2023-01-20'),
('Cluj-Napoca', 'Florești Conductă 1', 1003, 1, '02:30:00', 24, 4, '14:30:00', 10, 4, 100, -0.875, 0, 1, 23.5845678, 46.7490123, 'C1003', 'M1003', 'L2023-02', '2023-02-10'),
('Ploiești-Brașov', 'Câmpina Conductă 1', 1004, 1, '02:00:00', 24, 4, '14:00:00', 10, 4, 110, -0.920, 0, 0, 25.7323456, 45.1334567, 'C1004', 'M1004', 'L2023-02', '2023-02-15'),
('Timișoara-Arad', 'Arad Conductă 2', 1005, 3, '03:00:00', 24, 4, '15:00:00', 10, 4, 95, -0.880, 1, 0, 21.3134567, 46.1845678, 'C1005', 'M1005', 'L2023-03', '2023-03-01'),
('Brașov-Sibiu', 'Făgăraș Conductă 1', 1006, 1, '02:00:00', 24, 4, '14:00:00', 10, 4, 105, -0.890, 0, 0, 24.9736543, 45.8426789, 'C1006', 'M1006', 'L2023-03', '2023-03-15'),
('Craiova-Drobeta', 'Craiova Conductă 1', 1007, 1, '02:30:00', 24, 4, '14:30:00', 10, 4, 115, -0.910, 0, 1, 23.8017654, 44.3193456, 'C1007', 'M1007', 'L2023-04', '2023-04-01'),
('București-Constanța', 'Fetești Conductă 1', 1008, 3, '03:00:00', 24, 4, '15:00:00', 10, 4, 100, -0.860, 1, 0, 27.8334567, 44.3896543, 'C1008', 'M1008', 'L2023-04', '2023-04-10'),
...
('București-Constanța', 'Constanța Conductă 1', 1010, 1, '02:30:00', 24, 4, '14:30:00', 10, 4, 110, -0.870, 0, 0, 28.6365432, 44.1756789, 'C1010', 'M1010', 'L2023-05', '2023-05-15');
...
INSERT INTO limite_semnalizari (
    ...
    pcoff_h_v, pcoff_l_v,
    mod_reglare, mod_transmisie, acces,
    baterie_l_v,
    temperatura_h_c, temperatura_l_c,
    putere_gsm_l_dbm, putere_gps_l_dbm
) VALUES
-- mod_reglare: 0=PCoff, 1=PCon | mod_transmisie: 0=PROGRAMAT, 1=CURENT | acces: 0=PERMIS, 1=INTERZIS
('București-Ploiești', 'Buftea Conductă 1', 1001, 15.0, 10.0, 5.0, 1.0, -0.700, -1.000, 0.500, -0.750, -0.950, 0, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('București-Ploiești', 'Otopeni Conductă 2', 1002, 15.0, 10.0, 5.0, 1.0, -0.750, -1.050, 0.500, -0.800, -1.000, 1, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('Cluj-Napoca', 'Florești Conductă 1', 1003, 15.0, 10.0, 5.0, 1.0, -0.725, -1.025, 0.500, -0.775, -0.975, 0, 1, 1, 11.5, 60.0, -10.0, -90.0, -100.0),
('Ploiești-Brașov', 'Câmpina Conductă 1', 1004, 15.0, 10.0, 5.0, 1.0, -0.770, -1.070, 0.500, -0.820, -1.020, 0, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('Timișoara-Arad', 'Arad Conductă 2', 1005, 15.0, 10.0, 5.0, 1.0, -0.730, -1.030, 0.500, -0.780, -0.980, 1, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('Brașov-Sibiu', 'Făgăraș Conductă 1', 1006, 15.0, 10.0, 5.0, 1.0, -0.740, -1.040, 0.500, -0.790, -0.990, 0, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('Craiova-Drobeta', 'Craiova Conductă 1', 1007, 15.0, 10.0, 5.0, 1.0, -0.760, -1.060, 0.500, -0.810, -1.010, 0, 1, 1, 11.5, 60.0, -10.0, -90.0, -100.0),
('București-Constanța', 'Fetești Conductă 1', 1008, 15.0, 10.0, 5.0, 1.0, -0.710, -1.010, 0.500, -0.760, -0.960, 1, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('Iași-Bacău', 'Pașcani Conductă 2', 1009, 15.0, 10.0, 5.0, 1.0, -0.745, -1.045, 0.500, -0.795, -0.995, 0, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0),
('București-Constanța', 'Constanța Conductă 1', 1010, 15.0, 10.0, 5.0, 1.0, -0.720, -1.020, 0.500, -0.770, -0.970, 0, 0, 0, 11.5, 60.0, -10.0, -90.0, -100.0);
